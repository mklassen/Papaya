...
then
    ...
    java -jar lib/compiler.jar --warning_level QUIET --compilation_level SIMPLE_OPTIMIZATIONS --language_in=ECMASCRIPT_2020 --js build/papaya.js --js_output_file build/papaya-out.js
    rm build/papaya.js
